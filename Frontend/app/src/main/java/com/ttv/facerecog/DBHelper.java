...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table users " +
                        "(user_id integer primary key autoincrement,email text, face blob, feature blob)"
        );
    }
    ...
    public int insertUser (String email, Bitmap faceImg, byte[] feature) {
    ...
    public void getAllUsers() {
        ...
        while(res.isAfterLast() == false){
            ...
            FaceEntity face = new FaceEntity(user_id, email, faceImg, featureData);
